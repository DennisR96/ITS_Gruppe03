...
Hier lassen sich die Parameter Room und Damping, mit Encoder B und D anpassen. 
Zusätzlich kann der bandbegrenzte Hallanteil im Ausgangssignal mit Dry/Wet über Encoder C kontrolliert werden.
...
Mit Encoder B und D können in diesem Menüpunkt die Grenzfrequenzen verschoben werden. 
Mit Encoder C lässt sich weiterhin der bandbegrenzte Hallanteil im Ausganssignal kontrollieren. 
...
Encoder B, C und D sind auf dieselbe Weise belegt wie in Menüpunkt Zwei.
\newpage
\section{Umsetzung}
